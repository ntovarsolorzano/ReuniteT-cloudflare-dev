...
export default {
  ...
  theme: {
  	extend: {
        ...
        brand: {
  		...
  		backgroundImage: {
        'gradient-brand-title': 'linear-gradient(to right, #10b981, #f97316)',
  ...
  plugins: [
    ...
    plugin(function ({ matchUtilities, theme }) {
      matchUtilities(
        {
          'bg-dotted-pattern': (value) => ({
            backgroundImage: `radial-gradient(circle at center, ${value} 1px, transparent 1px)`,
